...
Este proyecto implementa un flujo para procesar, validar y normalizar transacciones desde archivos JSON, separando registros inválidos y generando una vista estructurada de los datos homogéneos.

## Estructura del Proyecto

- normalization_project/app.py: punto de entrada de la interfaz interactiva.
- normalization_project/config.py: reglas y configuraciones del proceso de normalización.
- normalization_project/normalizer.py: lógica principal para transformar los datos.
- normalization_project/validator.py: validación y separación de registros inválidos.
- normalization_project/metrics.py: cálculo de métricas y resúmenes.
